...
VALUES 
    (1, 'Projet A', 'Description du Projet A', 'projet_a.jpg', 'fichier_a.zip', 'https://www.youtube.com/watch?v=video_a'),
    (2, 'Projet B', 'Description du Projet B', 'projet_b.jpg', 'fichier_b.zip', 'https://www.youtube.com/watch?v=video_b'),
    (3, 'Projet C', 'Description du Projet C', 'projet_c.jpg', 'fichier_c.zip', 'https://www.youtube.com/watch?v=video_c'),
    (3, 'Projet D', 'Description du Projet D', 'projet_d.jpg', 'fichier_d.zip', 'https://www.youtube.com/watch?v=video_d'),
    (3, 'Projet E', 'Description du Projet E', 'projet_e.jpg', 'fichier_e.zip', 'https://www.youtube.com/watch?v=video_e'),
    (4, 'Projet F', 'Description du Projet F', 'projet_f.jpg', 'fichier_f.zip', 'https://www.youtube.com/watch?v=video_f');
...
VALUES 
    ('etudiant1@example.com', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', 'Etudiant', 'Dupont', 'Jean', '1234567890'),
    ('etudiant2@example.com', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', 'Etudiant', 'Martin', 'Sophie', '0987654321'),
    ('etudiant3@example.com', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', 'Etudiant', 'Lefevre', 'Julien', '9876543210'),
    ('etudiant4@example.com', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', 'Etudiant', 'Dubois', 'Emma', '0123456789'),
    ('etudiant5@example.com', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', 'Etudiant', 'Garcia', 'Léa', '4567890123');
INSERT INTO Utilisateur(motDePasse,type,nomUtilisateur,prenomUtilisateur,nomEntreprise,numeroTel,email,niveauEtude,ecole,ville) 
VALUES ("7110eda4d09e062aa5e4a390b0a572ac0d2c0220","Etudiant","Farret","Aventin",NULL,"0110011001","farretaven@cy-tech.fr","L1","CY Tech","Pau");
INSERT INTO Utilisateur(motDePasse,type,nomUtilisateur,prenomUtilisateur,nomEntreprise,numeroTel,email,niveauEtude,ecole,ville) 
VALUES ("7110eda4d09e062aa5e4a390b0a572ac0d2c0220","Etudiant","Toto","tata",NULL,"0220020301","toto@tata.titi","M1","CY Tech","Pau");
...
VALUES 
    ...
    ('admin2@example.com', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', 'Administrateur', 'Roux', 'Julie', '5566778899');
INSERT INTO Utilisateur(motDePasse,type,nomUtilisateur,prenomUtilisateur,nomEntreprise,numeroTel,email,niveauEtude,ecole,ville) 
    VALUES ("7110eda4d09e062aa5e4a390b0a572ac0d2c0220","Administrateur","Admin","istrateur",NULL,"0000000000","admin@ia.pau",NULL,NULL,"Pau");
...
VALUES 
    ...
    (1, 3, "Nous attendons d'apprendre de nouvelles techniques d'analyse de données.", 4),
    (2, 3, 'Oui, nous avons déjà participé à plusieurs défis de données auparavant.', 1),
    (3, 5, "Nous sommes intéressés par les projets liés à l'apprentissage automatique.", 4);
